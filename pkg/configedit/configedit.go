...
type appOut struct {
	...
	SDKVersion     string                   `yaml:"sdk-version,omitempty"`
	Command        string                   `yaml:"command,omitempty"`
	FinishArgs     []string                 `yaml:"finish-args,omitempty"`
	Sources        *config.SourcesConfig    `yaml:"sources,omitempty"`
